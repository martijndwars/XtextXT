...
public class XtextParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Xtext");
  ...
  { 
    XtextParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = XtextParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = XtextParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(XtextParseControllerGenerated.class);
    }
  ...
  { 
    return XtextParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
